document.addEventListener(
  ...
  function () {
    ...
    const inputTextSearch = document.querySelector(
    ...
    window.addEventListener("click", function (e) {
      dropdownLabel.forEach((o) => {
        ...
        if (o.classList.contains("open") || clicker != o) {
          ...
          document
            .querySelector(o.getAttribute("data-active"))
            .classList.remove("active-dropdown-mymenu");
        } else {
          ...
          document
            .querySelector(o.getAttribute("data-active"))
            .classList.add("active-dropdown-mymenu");
        }
      });

      if (
        (e.target == btnShowSearch &&
          formSearch.classList[2] == "d-xl-block") ||
        (e.target != btnShowSearch && e.target != inputTextSearch)
      ) {
    ...
    // slide Product
    const previousListProduct =
      '<div class="previous-list-product "> <i class="fas fa-chevron-left"></i>  </div>';
    const nextListProduct =
      '<div class="next-list-product"> <i class="fas fa-chevron-right"></i> </div>';
    $(".owl-carousel.produce-category").owlCarousel({
      margin: 10,
      nav: true,
      navText: [previousListProduct, nextListProduct],
      responsive: {
        0: {
          items: 1,
        },
